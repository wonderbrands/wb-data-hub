...
def process_fase_c():
    ...
    #ordenes listas para procesar
    query_pendientes = """
        SELECT id, marketplace_reference, ml_shipping_id, odoo_carrier_ref, odoo_carrier_id
    ...
    for order in orders:
        ...
        #Actualizar Base de Datos como Éxito (Guardando el ZPL raw)
        cursor.execute("""
            UPDATE tools.ml_api_etl_orders 
